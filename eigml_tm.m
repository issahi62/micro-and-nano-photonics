function [rm,tm,rma,tma]=eigml_tm(n1,n3,nl,the,wl,d,zl,do,tpl);

% [rm,tm,rma,tma]=eigml_tm(n1,n3,nl,the,wl,d,zl,do,tpl);
%
% Function calculates diffraction efficiencies rm (reflected)
% and tm (transmitted) for multilayer gratings in the case of 
% TM-polarisation. nl is matrix of refraction indexes in the gra-
